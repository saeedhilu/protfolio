...
const ParticlesBackground = () => {
  useEffect(() => {
    // Initialize tsParticles with the configuration
    tsParticles.load('tsparticles', {
      ...
      interactivity: {
        ...
        modes: {
          ...
          bounce: { distance: 200 },
          bubble: { distance: 200, duration: 0.4, mix: false, divs: { distance: 200, duration: 0.4, mix: false, selectors: [] } },
      ...
      particles: {
        ...
        stroke: { width: 0 },
        zIndex: { value: { min: 0, max: 100 }, opacityRate: 10, sizeRate: 10, velocityRate: 10 },
        destroy: { bounds: {}, mode: 'none', split: { count: 1, factor: { value: 3 }, rate: { value: { min: 4, max: 9 } }, sizeOffset: true, particles: {} } },
